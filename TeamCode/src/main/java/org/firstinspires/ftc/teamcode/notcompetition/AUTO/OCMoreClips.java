...
public class OCMoreClips extends OpMode{
    ...
    private enum AutoState{
        INITIALIZE, FIRST_PATH, SECOND_PATH, THIRD_PATH, FOURTH_PATH, FIFHT_PATH, SIXTH_PATH, SEVENTH_PATH, EIGHTH_PATH, NINTH_PATH, CLIP_DETECT_POSE, CLIP_UP_POSE, CLIP_RELEASE_POSE, PICK_DETECT_POSE, PICK_UP_POSE, PUT_DOWN_POSE, ARM_UP, ARM_DOWN, PARK_PATH, COMPLETE;
    }

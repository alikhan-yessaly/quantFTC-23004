...
public class FollowerConstants {
    ...
    private static double xMovement = 76.8716;
    private static double yMovement = 58.2097;
    ...
    public static double forwardZeroPowerAcceleration = -33.33047331207674;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -70.72382104847563;

...
public class FollowerConstants {
    ...
    private static double xMovement = 73.01;
    private static double yMovement = 55.36;
    ...
    public static double mass = 13.05942;
    ...
    public static double forwardZeroPowerAcceleration = -25.1707;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -56.6017;

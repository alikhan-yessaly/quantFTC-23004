...
public class FollowerConstants {
    ...
    private static double xMovement = 78.54;
    private static double yMovement = 60.79;
    ...
    public static double mass = 11.05942;
    ...
    public static double forwardZeroPowerAcceleration = -27.9771;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -60.0456;

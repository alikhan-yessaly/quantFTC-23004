...
public class FollowerConstants {
    ...
    private static double xMovement = 76.53;
    private static double yMovement = 59.45;
    ...
    public static double forwardZeroPowerAcceleration = -30.03529517094343;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -73.02938546447008;

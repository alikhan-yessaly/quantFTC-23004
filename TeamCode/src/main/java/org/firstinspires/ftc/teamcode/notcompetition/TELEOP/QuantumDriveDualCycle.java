...
@TeleOp(name = "QuantumDriveDualCycle")
public class QuantumDriveDualCycle extends LinearOpMode {
    @Override
...
//            if (gamepad2.x) {
//                // Rotate CCW
//                double currentWristP
//                os = wristServo.getPosition();
...
//            }
            ...
            if (!pickingMode) {
                if (gamepad2.right_stick_y > 0.5) {
                    ...
                    wrist.setPosition(piecePick1[3]);

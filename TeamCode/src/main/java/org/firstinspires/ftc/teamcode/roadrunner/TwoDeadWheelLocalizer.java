...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  -2319.727171430898; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1542.1821394270423; // x position of the perpendicular encoder (in tick units)
    }
